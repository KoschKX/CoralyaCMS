...
import { EditorBlockInserter } from "@/app/admin/editor/features/EditorBlockInserter";
import { EditorRightPanel } from "@/app/admin/editor/features/EditorRightPanel";
import { EditorCanvas } from "@/app/admin/editor/features/EditorCanvas";
    ...
    <div className="flex h-full flex-col overflow-hidden">
      ...
      <div className="flex flex-1 overflow-hidden">
        <EditorBlockInserter
          ...
          mainMode={mainMode}
          onAdd={(type) => { handleAddBlockFromPanel(type); setBlocksPanelOpen(false); }}
        />
        ...
        {/* Right panel */}
        <EditorRightPanel open={panelOpen}>
